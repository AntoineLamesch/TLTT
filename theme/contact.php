      ...
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <ul class="list-inline">
            ...
            <li class="list-inline-item text-white-50">Contactez-nous</li>
          </ul>
        </div>
      </div>
    </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-12 col-sm-12">
				<form id="contact-form" class="contact__form" method="post" action="../theme/cont.php">
					...
					<button class="btn btn-main" name="submit" type="submit">Envoyez votre message</button>
				</form>
			</div>

			<div class="col-lg-5 col-sm-12">
				<div class="contact-content pl-lg-5 mt-5 mt-lg-0">
					<h2 class="mb-5 mt-2">N'hésitez pas à nous contacter pour toute(s) information(s) qui vous semblerez nécessaire</h2>

					<ul class="address-block list-unstyled">
						<li>
							<i class="ti-direction mr-3"></i>3, RUE DE LA MAIRIE 62910 à EPERLECQUES
						</li>
						<li>
							<i class="ti-email mr-3"></i>Email: tltt.eperlecques@gmail.com
						</li>
						<li>
							<i class="ti-mobile mr-3"></i>Téléphone : 0321950027
						</li>
					</ul>

					<ul class="social-icons list-inline mt-5">
						<li class="list-inline-item">
							<a href="https://www.facebook.com/TLTTEperlecques"><i class="fab fa-facebook-f"></i></a>
						</li>
					</ul>
				</div>
			</div>
