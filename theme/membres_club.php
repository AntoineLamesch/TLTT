      ...
      <div class="row justify-content-between align-items-center">
        ...
        <div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
          <div class="header-top-info mb-2 mb-md-0">
             <a href="tel:+23-345-67890">Appelez-nous : <span>0321950027</span></a>
            <a href="mailto:support@gmail.com"><i class="fas fa-envelope mr-2"></i><span>tltt.eperlecques@gmail.com</span></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Les</span>
          <h1 class="text-capitalize mb-4 text-lg">Membres du club</h1>
		...
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					...
					<h2 class="mt-3 content-title">Voici les représentants du club</h2>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row portfolio-gallery">
			<div class="col-lg-4 col-md-6">
				<div class="portflio-item position-relative mb-4">
					<a href="images/Membres/hibon.jpg" class="popup-gallery">
						<img src="images/Membres/hibon.jpg" alt="portfolio" class="img-fluid w-100">
            <span class="h6 text-color">Président : Serge Hibon</span>
			...
			<div class="col-lg-4 col-md-6">
				<div class="portflio-item position-relative mb-4">
					<a href="images/Membres/synave.jpg" class="popup-gallery">
						<img src="images/Membres/synave.jpg" alt="portfolio" class="img-fluid w-100">

						<i class="ti-plus overlay-item"></i>

            <span class="h6 text-color">Secrétaire adjoint: Rémi Synave</span>
			...
			<div class="col-lg-4 col-md-6">
				<div class="portflio-item position-relative mb-4">
					<a href="images/Membres/decroix_m.jpg" class="popup-gallery">
						<img src="images/Membres/decroix_m.jpg" alt="portfolio" class="img-fluid w-100">

						<i class="ti-plus overlay-item"></i>

            <span class="h6 text-color">Responsable encadrement des jeunes : Marie Decroix</span>
			...
			<div class="col-lg-4 col-md-6">
				<div class="portflio-item position-relative mb-4">
					<a href="images/Membres/decroix_e.jpg" class="popup-gallery">
						<img src="images/Membres/decroix_e.jpg" alt="portfolio" class="img-fluid w-100">

						<i class="ti-plus overlay-item"></i>

            <span class="h6 text-color">Secrétaire: Eric Decroix</span>
			...
			<div class="col-lg-4 col-md-6">
				<div class="portflio-item position-relative  mb-4">
					<a href="images/Membres/zientowski.jpg" class="popup-gallery">
						<img src="images/Membres/zientowski.jpg" alt="portfolio" class="img-fluid w-100">

						<i class="ti-plus overlay-item"></i>

            <span class="h6 text-color">Secrétaire : Michael Zientowski</span>
